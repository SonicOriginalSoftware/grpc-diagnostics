...
Protobuf interface definitions for common gRPC service capabilities. Provides
standard service contracts that microservices can implement for observability
